...
class SquareAntiprism:
    def __init__(
        ...
        bot = [glm.vec3(math.cos(i * math.pi / 2 + math.pi/4) * r, -h, math.sin(i * math.pi / 2 + math.pi/4) * r) for i in range(4)]
        top = [glm.vec3(math.cos(i * math.pi / 2) * r, h, math.sin(i * math.pi / 2) * r) for i in range(4)]
        ...
        vertices += face(bot[0], bot[2], bot[1]) + face(bot[0], bot[3], bot[2])
        vertices += face(top[0], top[1], top[2]) + face(top[0], top[2], top[3])
